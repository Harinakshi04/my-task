...
const DashboardPage: React.FC = () => {
  ...
  <div className="flex items-center gap-10"> 
   ...
   <div className="hidden lg:flex items-center justify-center">
        ...
        {/* Skills Card */}
         <div className="hidden lg:flex p-10 h-500px w-900px items-center gap-4 justify-center">
          <Card>
            <CardContent>
              ...
              <Box mt={2}>
                ...
                <Box sx={{ height: 8, background: "#e0e0e0", borderRadius: 5 }}>
                  <Box sx={{ width: "90%", height: 8, background: "#1976d2", borderRadius: 5 }} />
                </Box>
              ...
              <Box mt={2}>
                ...
                <Box sx={{ height: 8, background: "#e0e0e0", borderRadius: 5 }}>
                  <Box sx={{ width: "85%", height: 8, background: "#1976d2", borderRadius: 5 }} />
                </Box>
                <Typography variant="caption" color="primary">
                  Expert
                </Typography>
